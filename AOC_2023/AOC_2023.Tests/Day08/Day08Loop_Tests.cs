...
public class Day08LoopTests
{
    [Fact]
    public void Test_Part1_Sample()
    {
        var solver = new Day08Loop();
    ...
    {
        var solver = new Day08Loop();
        Assert.Equal((long)6, solver.Part2("Day08/sample3.txt"));
    }
    ...
    {
        var solver = new Day08Loop();
        Assert.Equal((long)17099847107071, solver.Part2("Day08/input.txt"));
    }
}